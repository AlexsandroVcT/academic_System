    ...
    <div class='widget-content nopadding'> 
        <table class='table table-bordered table-hover'>
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                $row_exist = $attendance_res->fetch_assoc();
                ...
                if ($curr_date == $todays_date) {
                    ...
                    echo "<div class='text-center'><a href='actions/delete-attendance.php?id=$user_id'><button class='btn btn-danger'>Check Out <i class='fas fa-clock'></i></button></a></div>";
                } else {
                    echo "<div class='text-center'><a href='actions/check-attendance.php?id=$user_id'><button class='btn btn-info'>Check In <i class='fas fa-map-marker-alt'></i></button></a></div>";
                }
                echo "</td>";
                echo "</tr>";
                echo "</tbody>";
